...
export const detailedServices = [
  {
    ...
    included: [
      'Prelavado y lavado Snow Foam con champú pH neutro',
      'Limpieza de llantas y restos férricos',
      'Limpieza detallada de motor',
      'Tratamiento regenerador de plásticos interiores y exteriores',
      'Rotativo',
      'Recuperador de neumáticos',
      'Limpieza de cristales y lavado a contacto',
      'Aspirado profundo con tornados',
      'Limpieza de marcos de puerta y gomas',
      'Alfombrilla profunda con cepillo rotativo',
      ...
      'Hidratación de cuero + limpieza de alcántara y textiles',
      'Sanitización con vapor y desinfección completa del habitáculo',
    ],
  },
];
...
export const durationBySize: Record<string, Record<string, string>> = {
  absolute: {
    ...
    furgon: 'Duración aproximada: 8 a 10 horas',
  },
};
...
export const essentialImagesBySize: Record<string, string> = {
  ...
  furgon: 'https://readdy.ai/api/search-image?query=white%20commercial%20van%20front%20view%20in%20dimly%20lit%20detailing%20workshop%20being%20foam%20cleaned%20professional%20overhead%20lights%20dark%20background%20water%20and%20soap%20on%20bodywork%20no%20people%20realistic%20elegant%20understated%20premium%20detailing%20bay&width=800&height=600&seq=essential-furgoneta-v1&orientation=landscape',
};
...
export const absoluteImagesBySize: Record<string, string> = {
  ...
  furgon: 'https://readdy.ai/api/search-image?query=commercial%20van%20interior%20cabin%20dashboard%20and%20seats%20being%20detailed%20cleaned%20dark%20professional%20workshop%20soft%20overhead%20lighting%20no%20people%20realistic%20textures%20premium%20leather%20care%20elegant%20understated%20moody%20atmosphere&width=800&height=600&seq=absolute-furgoneta-v1&orientation=landscape',
};
