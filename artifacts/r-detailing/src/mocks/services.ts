export const basicService = {
  ...
  price: 30,
  duration: 'Duración aproximada: 1,5 - 2 horas',
...
'Lavado exterior a contacto mediante método de doble cubo y guantes de microfibra con champú pH neutro',
'Limpieza de llantas con descontaminación férrica y eliminación de suciedad incrustada',
'Restauración y acondicionamiento de plásticos interiores y exteriores',
'Acondicionamiento y acabado satinado de neumáticos',
'Limpieza y desengrasado de cristales interiores y exteriores',
'Aspirado interior de precisión mediante sistema Tornador',
'Limpieza detallada de marcos de puerta, juntas y gomas con brocha',
'Limpieza de rejillas, emblemas y zonas de difícil acceso',
'Limpieza profunda de alfombrillas mediante cepillo rotativo',
